				...
				<!-- Series One Info -->
					...
					<div class='serie_info_container off' id='special_info'>
						<div class='description_container'>
							...
							<p>Sometimes two stars collide in the air before falling on the ground. When that happens, two different energies merge and the result is an incredible Fusion Star Monster. You will recognize them because their bases are in different colors than their bodies. They also have a high star value. Don't miss them!</p>
						</div>

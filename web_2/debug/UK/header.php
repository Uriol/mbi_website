...
<header>
	...
	<article class='menu'>
		<div id='main_menu'>
			...
			<a href='http://localhost:8888/mbi_2/web_2/debug/UK/index.php'>
				<div id='menu_logo'></div>
			</a>
			<div id='menu_ul_container'>
				<ul class='main_menu'>
					<li class='menu_item' id='red_item'>PRODUCTS<span> ▼</span></li>
					<a href="http://localhost:8888/mbi_2/web_2/debug/UK/company/index.php">	
						<li class='menu_item' id='green_item'>COMPANY</li>
					</a>
					<a href="http://localhost:8888/mbi_2/web_2/debug/UK/contact/index.php">	
	...
	<article id='submenu' class='off'>
		<div id='submenu_products_container'>
			<a href="http://localhost:8888/mbi_2/web_2/debug/UK/star_monsters/index.php">		

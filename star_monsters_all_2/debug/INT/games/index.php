...
<html>
	...
	<body>
		...
		<script>
			...
			game_1 = new Image();
			game_1.src = "../../img/juegos/game_1_uk.png";

			game_2_bg = new Image();
			game_2_bg.src = "../../img/juegos/game_2_bg.png";
			game_2 = new Image();
			game_2.src = "../../img/juegos/game_2_uk.png";

			game_3_bg = new Image();
			game_3_bg.src = "../../img/juegos/game_3_bg.png";
			game_3 = new Image();
			game_3.src = "../../img/juegos/game_3_uk.png";

			game_4_bg = new Image();
			game_4_bg.src = "../../img/juegos/game_4_bg.png";
			game_4 = new Image();
			game_4.src = "../../img/juegos/game_4_uk.png";

			game_5_bg = new Image();
			game_5_bg.src = "../../img/juegos/game_5_bg.png";
			game_5 = new Image();
			game_5.src = "../../img/juegos/game_5_uk.png";

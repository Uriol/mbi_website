...
<html>
	...
	<body>
		...
		<script>
			...
			origin_img.src = "../img/history/history_1.png";

			history_2_img = new Image();
			history_2_img.src = "../img/history/history_2.png";

			history_3_img = new Image();
			history_3_img.src = "../img/history/history_3.png";

			history_4_img = new Image();
			history_4_img.src = "../img/history/history_4.png";

			history_5_img = new Image();
			history_5_img.src = "../img/history/history_5.png";

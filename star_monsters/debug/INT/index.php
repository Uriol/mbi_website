			...
			<section class='info'>
				<article class='info_container'>
					...
					<div class='text_container margin'>
						<h1>The Origin</h1>
						<p>A Star Monster emerges with the energy of a star and the properties of the place where they land. The star can fall anywhere, and so the Star Monsters have very different origins. The shape of each Star Monster gives us a clue to its origin.</p>
					</div>
					...
					<div class='text_container margin'>
						<h1>Here They Are</h1>
						<p>Its base is always a three-pointed, triangular star. They are all different, full of colour, original, fun… they're unique!</p>
					</div>
					<div class='story_image'>
					...
					<div class='text_container margin'>
						<h1>Evolved</h1>
						<p>Some stars fall with extra energy.And so, after the original transformation and the colours, these Star Monster evolve! With the evolution the Star Monster changes its shape and can have new colours, but mainly, it improves its skills and increases its value.</p>
					</div>
					<div class='story_image'>

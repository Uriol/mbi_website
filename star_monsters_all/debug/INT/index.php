			...
			<section class='info'>
				<article class='info_container'>
					...
					<div class='text_container margin'>
						<h1>The Origin</h1>
						<p>The star lands and takes on characteristics from the environment around it. A star can fall anywhere, which means that Star Monsters can be created with limitless possibilities... The shape of each Star Monster gives us a clue to its origin.
					</div>
					...
					<div class='text_container margin'>
						<h1>Evolved</h1>
						<p>Some stars fall with extra energy. After the original transformation, these Star Monsters evolve! With evolution, the Star Monster changes shape and can have new colours. Most importantly, it improves its skills and increases its value.
					</div>
					<div class='story_image'>

...
<header>
	...
	<article class='menu'>
		<div id='main_menu'>
			...
			<a href='http://localhost:8888/mbi_2/ES/index.php'>
				<div id='menu_logo'></div>
			</a>
			<div id='menu_ul_container'>
				<ul class='main_menu'>
					<li class='menu_item' id='red_item'>PRODUCTOS<span> ▼</span></li>
					<a href="http://localhost:8888/mbi_2/ES/company/index.php">	
						<li class='menu_item' id='green_item'>COMPAÑIA</li>
					</a>
					<a href="http://localhost:8888/mbi_2/ES/contacto/index.php">	
	...
	<article id='submenu' class='off'>
		<div id='submenu_products_container'>
			<a href="http://localhost:8888/mbi_2/ES/star_monsters/index.php">		
				<div id='submenu_product_one' class='submenu_product_start'></div>
			</a>
			<a href="http://localhost:8888/mbi_2/ES/zomlings/index.php">	
